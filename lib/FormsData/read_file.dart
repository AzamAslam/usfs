...
import 'package:webviewjavascript/FormsData/open_database.dart';
...
class ReadFile extends StatefulWidget {
  ...
  ReadFile({Key key, this.file, this.tableName}) : super(key: key);
...
class _ReadFileState extends State<ReadFile> {
  ...
  openDatabase() async {
    ...
    print('tableNamesFromDb here');
    print(tableNamesFromDb);

    tablesName = List.generate(
        tableNamesFromDb.length,
        (index) => DataColumn(
            label: Text(tableNamesFromDb[index]['name'].toString())));
                                          ...
                                          child: Column(
                                            children: <Widget>[
                                              ...
                                              getTextFieldForFilter(
                                                  getColumnName(globalTableName, 0),
                                                  widthScreen,
                                                  heightScreen,
                                                  controller1),
                                              getTextFieldForFilter(
                                                  ...
                                                  TextButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      filterValues = [
                                                        ...
                                                        {
                                                          'columnName': getColumnName(widget.tableName, 2),
                                                          'filterValue': controller3.text.isNotEmpty ? controller3.text : '%'
                                                        },
                                                      ];
...
class MyData extends DataTableSource {
  final List<Map<String, dynamic>> _data = getList;
