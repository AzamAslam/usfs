...
// class TestDownloader extends StatelessWidget {
//   @override
...
class TestDownloader extends StatefulWidget with WidgetsBindingObserver {
  final TargetPlatform platform;

  TestDownloader({Key key, this.title, this.platform}) : super(key: key);

  final String title;

  @override
  _TestDownloaderState createState() => new _TestDownloaderState();
}

class _TestDownloaderState extends State<TestDownloader> {
  final _documents = [
    {
